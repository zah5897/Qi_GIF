...
import com.zhan.qiwen.page.WebActivity;
import com.zhan.qiwen.utils.GlideImageGetter;
import com.zhan.qiwen.utils.HtmlUtil;
import com.zhan.qiwen.utils.LinkMovementMethodExt;
import com.zhan.qiwen.utils.SpanClickListener;
...
//                intent.putExtra(CreateTopicReplyActivity.TOPIC_ID,
...
//                        topicReply.getTopicReply().getUser().getLogin());
//                view.getContext().startActivity(intent);
            }
        };
