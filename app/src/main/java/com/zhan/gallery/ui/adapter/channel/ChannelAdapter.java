...
import com.zhan.gallery.ui.listener.OnChannelDragListener;
...
public class ChannelAdapter extends BaseMultiItemQuickAdapter<Channel> {
    ...
    public ChannelAdapter(List<Channel> data) {
        ...
        //默认没有编辑
        mIsEdit = false;
        addItemType(Channel.TYPE_MY_CHANNEL_TAG, R.layout.item_channel_title);
        addItemType(Channel.TYPE_MY_CHANNEL, R.layout.item_channel);
        addItemType(Channel.TYPE_OTHER_CHANNEL_TAG, R.layout.item_channel_title);
    ...
    protected void convert(final BaseViewHolder baseViewHolder, final Channel channel) {
        switch (baseViewHolder.getItemViewType()) {
            case Channel.TYPE_MY_CHANNEL_TAG:
                //我的频道
                //赋值，以便之后修改文字
                ...
                break;
            case Channel.TYPE_OTHER_CHANNEL_TAG:
                //频道推荐
                baseViewHolder.setText(R.id.tvTitle, channel.title)
            ...
            case Channel.TYPE_MY_CHANNEL:
                ...
                if (!channel.isDefault) {
                    ...
                    baseViewHolder.setOnClickListener(R.id.ivDelete, new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            //执行删除，移动到推荐频道列表
                            if (mIsEdit) {
